...
But suppose that we now want to make a map of the current day's **active cases** in the subregions of SLC like the <a href="https://www.stlawco.org/covid-19-daily-update-center" target="_blank">maps found here</a> . We need to tell `R` how to draw the lines that define the different subregions of SLC. To do so, we need to provide `R` with a **shapefile** that has directions on how to draw the spatial polygons.
...
**Exercise 4**. Read about Mercator projections in <a href="https://futuremaps.com/blogs/news/top-10-world-map-projections" target="_blank">this blog post</a>. What does this source say about the sizes of Greenland vs. Africa in a Mercator projection.
