...
5. Use visualization to convey the meaning of regression models to a general audience.
...
There will be reading assignments and exercises as "Class Prep," each worth about 5 points for a total of __75 points__. Each "Class Prep" will be some combination of notes from a reading, exercises answered with code, or some other task.

Collaboration is permitted on all reading assignments and exercises, but AI usage is not permitted on any reading assignment or exercise set.

### Participation

At three separate times throughout the semester, you will complete an assessment on how you feel you have participated in and engaged with our course. Each of these assessments will be worth __25 points__ (for a total of __75 points__). The specific assessment will be shared on Canvas at the start of the semester.

<!-- 29 total class meetings -->
<!-- 5 assessments (down to 24) -->
<!-- nothing on skip day (down to 23) -->
<!-- nothing on last day of class (down to 22) -->

<!-- For most of the non-assessment class meetings, you will turn in a visualization sketch for a particular problem or something similar as a small group. In the back third of the class, you will instead turn in a short feedback rubric on final project drafts for other students in the class. -->

<!-- Each of these will be worth __4 points__ and there are about 88 possible points. However, life happens and you may need to miss a couple of classes. Therefore, participation will be graded out of __75 points__. There will not be extra credit for earning more than 75 points so that no one is penalized for needing to miss a couple of classes. There will not be any make-ups for participation. -->
...
Additionally, there is an additional 100 points that will be the average of your __top 4__ assessments.

### Final Project

Finally, there are __150 points__ for the final project. These points will be split amongst a few different components of the final project: details will be provided later in the semester.

### Point Breakdown

Therefore, based on the information above, the point breakdown for the course is:

* 75 points for reading assignments and exercises (class prep).
* 75 points for participation.
* 100 points for blog posts.
* 600 points for assessments.
...
* use of generative AI (like Chat GPT) is __not__ permitted on any of the assessments at all. If you use AI for help on something in your blog post final project, or the class prep, then you must include the search prompt and what you are using, specifically. 
...
| Week | Date | Topics |
| ---- | ----------- | ----------------------------------------- |
| 0 | 1/14  | Core Concepts |
| 1 | 1/19 | Core Concepts and Introduction to Git and GitHub |
| 2 | 1/26 | DATA/STAT 234 Review and Assessment 1 |
| 3 | 2/2 | Mapping and Blog Post 1 |
| 4 | 2/9 | Expressing Uncertainty and STAT 213 Review  |
| 5 | 2/16|  Model Visualization and Assessment 2 |
| 6 | 2/23 | Logistic Regression and Blog Post 2 |
| 7 | 3/2 | Other Topics and Assessment 3  |
| 8 | 3/9 | Ethics and Blog Post 3 |
| 9 | 3/16 | Interactivity and Assessment 4|
||||
|  | 3/23 | Spring Break |
||||
| 10 | 3/30 | Shiny Introduction and Project Introduction |
| 11 | 4/6 | Shiny Reactivity and Assessment 5 |
| 12 | 4/13 | Project |
| 13 | 4/20 | Project |
| 14 | 4/27 | Project |
||||
