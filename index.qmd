...
There will be __40__ sets of Exercises and GitHub pushes, each worth 5 points for a total of __200 points__. What these 5 points will come from include:

* exercise sets that consist of completing some of our course materials (in the sections called "Class Prep") before class.
* evaluation of your participation in class a few times throughout the semester
* GitHub pushes that will contain work on your final project (completed in the back third of the semester).
* Feedback rubrics on final projects for other students in the class (completed in the back third of semester).
