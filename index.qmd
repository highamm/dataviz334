...
There will be two minor tests of visualization, each worth __75 points__, one moderate test of visualization worth __100 points__, and two major tests of visualization, each worth __150 points__. All but one of these will consist of a combination of an in-class exam and a 25-point take-home blog post. The total number of points for these is __550 points__. More information will be provided in class.

### Final Project

Finally, there are __150 points__ for the final project, which will be a large blog post visualizing one or more data sets of your choosing. These points will be split amongst a few different components of the final project: details will be provided later in the semester.
