...
__Exercise 2d__. Run `leaflet(beer_location) |> setView(lng = -98.583, lat = 39.833, zoom = 4) |> addTiles() |> addProviderTiles(providers$Wikimedia) |> addMarkers(lng = beer_location$Longitude, lat = beer_location$Latitude)` and explain what the `addMarkers()` function does.
