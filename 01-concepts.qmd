...
Read Sections 1.1 - 1.2 of Kearen Healy's *Data Visualization: A Practical Introduction*, found <a href="https://socviz.co/lookatdata.html" target="_blank">here</a>. As you read, answer the following questions in just 1 to 2 sentences.
...
A list of `<GEOM>`'s and their default `<STAT>` and `<POSITION>` values are given <a href="http://sape.inf.usi.ch/quick-reference/ggplot2/geom
...
b.  add a colour asethetic to make three different frequency lines, one for each `species` of penguin.
