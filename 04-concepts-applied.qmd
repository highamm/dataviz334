...
__Example 6__: Construct two different plots (a bar plot and a lollipop plot) using the Happy Planet Index data to show the top 10 and bottom 10 countries for the `HappyPlanetIndex` variable, a variable that is meant to measure how "happy" its citizens while taking into account how the average citizen from that country affects our planet. 
...
Construct and examine each plot. Which plot is preferable? Can you relate your choice to a concept in the reading?
