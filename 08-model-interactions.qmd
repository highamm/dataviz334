...
## first variable is assumed to be the quantitative variable
## can also give a vector of specific values that you want predictions for
ggpredict(mod_comp, terms = c("bty_avg",
                              "age [c(4, 7, 11)]",
                              "gender")) |>
  as.data.frame(terms_to_colnames = TRUE) |>
  as_tibble()
