...
<input type="checkbox"> Install Git by following along with <a href="https://happygitwithr.com/install-git.html" target="_blank">Section 6 of Happy Git for the useR </a>. Note that I removed the video for this step because the directions are different depending on whether you are on Windows, MacOS, or Linux. Also note that you will need to access the Shell. You can do this from R Studiofrom the `Tools` option: `Tools -> Shell`. </input>
...
<input type="checkbox"> Watch and follow along with a <a href="https://www.youtube.com/watch?v=9RuXy0s3T4U" target="_blank"> video on making commits, pushing, and pulling</a>. </input>
