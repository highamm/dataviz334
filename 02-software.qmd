...
Finally, download the `data.zip` file from Canvas (in Modules), unzip it, and put the data folder in the same folder that your new R Project is in. This `data` folder contains many data sets that we will use throughout the semester!
...
d.  In what semester and year did you take DATA/STAT 234?

e.  Have you used Git before? If so, in what context?
