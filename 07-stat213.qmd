...
We see right away that there are not any potentially influential observations (using a Cook's distance of 0.5 as a cut-off value). 
...
Finally, we can use our `ggplot2` skills to construct plots like a residuals versus fitted values plot:
